      ...
      >
        ...
        <div className="mb-3 col-md-12">
          <input
            ...
            id="name"
            name="name"
            placeholder="Second Author's Name ( Optional )"
            // value={this.state.name}
            // onChange={this.handleInputChange}
          />
        </div>
        <div className="mb-3 col-md-12">
          <input
            ...
            id="name"
            name="name"
            placeholder="Third Author's Name ( Optional )"
            // value={this.state.name}
            // onChange={this.handleInputChange}
          />
        </div>
        ...
        <div className="mb-3">
          <input
            ...
            name="phoneNumber"
            required=""
            placeholder="Phone Number ( Preferably WhatsApp No. )"
        ...
        <div className="mb-3">
          <input
            ...
            name="paymentId"
            required=""
            placeholder="Payment ID ( UPI / UTR Number )"
